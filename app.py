...
# CONFIG
# =============================
API_BASE = "https://movie-recommendation-system-7-n0zo.onrender.com" or "http://127.0.0.1:8000"
...
if st.session_state.view == "home":
    ...
    # HOME FEED MODE
    display_category = (home_category or "home").replace("_", " ").title()
    st.markdown(f"### 🏠 Home — {display_category}")
